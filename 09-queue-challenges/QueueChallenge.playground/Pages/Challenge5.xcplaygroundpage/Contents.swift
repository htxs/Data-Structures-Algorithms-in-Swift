...
class DequeDoublyLinkedList<Element>: Deque {
...
extension DequeDoublyLinkedList: CustomStringConvertible {
    public var description: String {
        String(describing: list)
    }
}

example(of: "DequeDoublyLinkedList") {
    var deque = DequeDoublyLinkedList<Int>()
    deque.enqueue(1, to: .back)
    deque.enqueue(2, to: .back)
    deque.enqueue(3, to: .back)
    deque.enqueue(4, to: .back)
    
    print("Deque after enqueue 4 element to back: \(deque)")
    
    deque.enqueue(5, to: .front)
    
    print("Deque after enqueue 1 element to front: \(deque)")
    ...
    print("Deque after dequeue 2 element from back and dequeue 2 element from front: \(deque)")
}
